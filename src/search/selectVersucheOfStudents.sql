...
SELECT schuelerId as schueler_id, versuchId as versuch_id, versuch.kategorieId as kategorie_id, kategorien.kateGroupIdBJS as kat_group_id_bjs, kategorien.kateGroupIdDOSB as kat_group_id_dosb, versuch.punkte as bjs_punkte, versuch.wert as wert, 
    IIF(silber<gold, 
